export const UseCard = (props) => {
    const classes = () => {
        ...
        const bg = props.bgcolor ? " bg-seashell" + props.bgcolor : "";
        const txt = props.txtcolor ? " text-" + props.txtcolor : "";
        const opacity = props.opacity ? " bg-opacity-50" + props.opacity : "";
    ...
    return (
        ...
        >
            <h5
                ...
                style={{ backgroundColor: "indianred", textAlign: "center" }}
            >
                {props.header}
            </h5>
